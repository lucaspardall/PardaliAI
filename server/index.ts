...
(async () => {
  try {
    ...
    // Adicionar rota direta para autenticação Shopee (independente de autenticação Replit)
    app.use('/shopee-connect', (await import('./routes/direct-shopee')).directShopeeRouter);
